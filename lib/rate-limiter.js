...
export const RATE_LIMITS = {
  // Authentication endpoints - stricter limits (but more reasonable)
  auth: {
    windowMs: 15 * 60 * 1000, // 15 minutes
    maxRequests: 10, // 10 requests per 15 minutes (increased from 5)
    blockDurationMs: 15 * 60 * 1000, // Block for 15 minutes if exceeded (reduced from 30)
  },
  // General API endpoints - increased for normal usage
  api: {
    windowMs: 1 * 60 * 1000, // 1 minute
    maxRequests: 300, // 300 requests per minute (increased from 60) - allows multiple page refreshes
    blockDurationMs: 5 * 60 * 1000, // Block for 5 minutes if exceeded (reduced from 10)
  },
  ...
  // Default for unknown endpoints - increased for normal usage
  default: {
    windowMs: 1 * 60 * 1000, // 1 minute
    maxRequests: 200, // 200 requests per minute (increased from 30)
    blockDurationMs: 5 * 60 * 1000, // Block for 5 minutes if exceeded (reduced from 10)
  },
};
